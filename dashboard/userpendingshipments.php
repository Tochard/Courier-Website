	...
	<div class="wrapper">
		...
		<div class="contents">
			...
			<div class="body-content">
				...
				<div class="b-content">
					<div class="b-heading">
						<h2>Update Pending Shipments</h2>
								...
								<tbody>
									...
									?>
											<tr>
												...
												<td data-label="sender email"><?php echo $row['semail'] ?></td>
												<td data-label="sender phone"><?php echo $row['sphone'] ?></td>
												<td data-label="Rname"><?php echo $row['recName'] ?></td>
